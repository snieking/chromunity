...
describe('<StarRating />', () => {
  ...
  it('should render <IconButton /> if toggleRating provided', () => {
    const wrapper = shallow(
      <StarRatingPresentation ratedBy={ratedBy} ratedByMe={false} toggleRating={() => null} disabled={false} />
    );
  ...
  it('should render a disabled <IconButton /> if disabled prop', () => {
    const wrapper = shallow(
      <StarRatingPresentation ratedBy={ratedBy} ratedByMe={false} toggleRating={() => null} disabled />
    );
  ...
  it('should have <StarRate /> if rated by me', () => {
    const wrapper = shallow(
      <StarRatingPresentation ratedBy={ratedBy} ratedByMe toggleRating={() => null} disabled={false} />
    );
