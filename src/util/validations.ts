export function validate(valueValidators: any, callback: Function) {
...
export const publicKey = (error: string) => (value: string) => value && value.match('^[0-9a-fA-F]{66}$') ? null : error;
