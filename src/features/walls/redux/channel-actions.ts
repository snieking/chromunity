...
import { ChannelActionTypes, ILoadChannel, ILoadChannelByPopularity, IUpdateChannel } from './channel-types';
...
export const loadOlderTopicsInChannel = createAction(
  ChannelActionTypes.LOAD_OLDER_CHANNEL_TOPICS,
  withPayloadType<number>()
);

export const loadChannelByPopularity = createAction(
  ChannelActionTypes.LOAD_CHANNEL_POPULARITY,
  withPayloadType<ILoadChannelByPopularity>()
);
