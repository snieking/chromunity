...
import { getTimesRepresentative } from '../../../core/services/representatives-service';
import {
  countRepliesByUser,
...
import { electionCandidateCardStyles } from '../shared-styles';
...
interface Props {
  candidate: string;
  votedFor: string;
  voteForCandidate: (name: string) => void;
