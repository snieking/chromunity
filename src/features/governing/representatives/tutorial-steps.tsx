    ...
    },
    {
      ...
      content: () => (
        <div style={{ color: COLOR_CHROMIA_DARK }}>
          ...
          <p>
            A governing log is publicly available here on Chromunity so that if a representative misbehaves, it will be
            visible and other representatives can take action.
          </p>
        </div>
      ),
    },
